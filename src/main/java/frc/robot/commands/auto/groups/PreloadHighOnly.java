...
public class PreloadHighOnly extends SequentialCommandGroup {

    public PreloadHighOnly(DriveSystem driveSystem, ArmExtendSystem armExtendSystem, ArmRotateSystem armRotateSystem, ClawSystem clawSystem) {
        addCommands(
